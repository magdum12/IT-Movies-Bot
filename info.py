...
# Bot information
SESSION = environ.get('SESSION', 'ITMoviesBot')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001850204479') # give your force subscribe channel id here else leave it blank
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+UBeU4cZUCDpjZDI1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'It_movies_bot') # Support Chat Link Without https:// or @
